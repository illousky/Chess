...
describe("Round Robing 10 players tournament OTB, admin modifies results", () => {
  ...
  it("Round Robin OTB tournament, admin modifies resultss", () => {
    ...
    // cy.wait(10000); // wait for the tournament to be created
    ...
    // cy.wait(15000); // wait for the tournament to be created
    ...
    // cy.wait(5000); // wait for the tournament to be created
