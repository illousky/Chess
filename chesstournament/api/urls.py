...
from .views import (RefereeViewSet, PlayerViewSet,
                    GameViewSet, TournamentViewSet,
                    RoundViewSet, CustomUserViewSet,
                    CreateRoundAPIView, SearchTournamentsAPIView,
                    TournamentCreateAPIView, GetRanking,
                    GetPlayers, GetRoundResults,
                    UpdateLichessGameAPIView, UpdateOTBGameAPIView,
